...
const characters = [
    ...
    { id:3, img:'assets/c_003.png', name:'오수아', desc:'은성이의 껌딱지 절친.\n하지만 최근 은성이 곁을 맴도는\n남학생들이 몹시 거슬려 폭주하기 직전이다.' },
    { id:4, img:'assets/c_004.png', name:'차재현', desc:'모두의 첫사랑이자 연극부 부장.\n언제나 여유 넘치지만, 도유진 앞에만 서면\n묘하게 뚝딱거린다.' },
    { id:5, img:'assets/c_005.png', name:'윤해수', desc:'빈틈없는 송현고 최고 여신.\n남 일에 무관심한 척하면서 우리 반 기류를\n제일 정확하게 꿰뚫어 본다.' }
];

const questions = [
    {
        q:"나른한 문학 시간,<br>얼굴 천재 전학생 유진이가 자꾸 우리 분단 쪽을 빤히 쳐다본다.<br>그 시선의 끝엔 학교 여신 '윤해수', 연극부장 '차재현',<br>그리고 조용한 '이은성'이 있다.<br><br>당신의 촉이 발동하는 방향은?",
        img1:"assets/q1_1.png", img2:"assets/q1_2.png",
        choices:[
            {text:"자꾸 이쪽을 보네... 설마 나한테 첫눈에 반한 건가?!", score:0},
            {text:"당연히 송현고 여신 윤해수일 듯.\n딱 봐도 남주 여주 같잖아! 둘이 곧 사귀겠네", score:5},
            {text:"잠깐, 시선의 방향이 미묘한데?\n설마 대본 연습 중인 연극부장 차재현을 보고 있는 거 아냐?", score:10},
        ]
    },
    {
    ...
    {
        q:"제비뽑기로 자리를 바꾸는 날.<br>가장 먼저 번호를 뽑은 전학생 도유진이 향한 곳은,<br>밝은 분위기의 친구들이 모인 명당이나 여신 윤해수의<br>옆자리가 아니었다.<br>도유진이 고른 자리는 굳이 교실 맨 구석, 조용한 이은성의<br>바로 뒷자리?<br><br>대체 왜 저길 고른 걸까?",
        img1:"assets/q3_1.png", img2:"assets/q3_2.png",
        choices:[
            {text:"도유진이 이은성한테 마음 있는 거 아니야?", score:5},
            {text:"둘이 접점이 하나도 없는데.\n약점이라도 잡혔나?", score:10},
            {text:"맨 뒷자리 구석 완전 명당이잖아,\n엎드려 자도 쌤한테 절대 안 걸리는 자리!", score:0}
        ]
    },
    {
        q:"이은성과 화장실도 같이 가던 껌딱지 오수아.<br>최근 이은성이 조별 과제로 남학생들과 친해지자,<br>왠지 오수아의 태도가 차가워졌다.<br><br>오수아의 속마음은 뭘까?",
        img1:"assets/q4_1.png", img2:"assets/q4_2.png",
        choices:[
            {text:"이은성이 친구가 많아지니까,\n자기는 버림받을까 봐 두렵고 질투나는 거 아냐?", score:10},
            {text:"저 남학생 중에 오수아가 좋아하는 애가 있나 봐", score:5},
            {text:"조별 과제를 남자애들이 다 해줬다던데,\n그래서 괜히 심통 났나봐", score:0}
        ]
    },
    {
        q:"이은성이 유독 우울해 보이던 날 아침,<br>책상 위에 이은성이 좋아하는 딸기바 아이스크림이 놓여 있다.<br>그걸 본 이은성이 굳어 버리자, 오수아는 애써 시선을 피하며 엎드리고<br>도유진은 그 광경을 가만히 지켜보고 있다.<br><br>저 아이스크림은 누가, 왜 둔 걸까?",
        img1:"assets/q5_1.png", img2:"assets/q5_2.png",
        choices:[
            {text:"누가 둔 게 뭐가 중요해,\n아침부터 공짜 간식이라니 부럽다!", score:0},
            {text:"오수아가 이은성이랑 화해하고 싶었나?", score:10},
            {text:"미쳤다, 백퍼 도유진이 이은성 좋아한다ㅠ", score:5},
        ]
    },
    {
        q:"연극부 대본 리딩 시간.<br>평소 능글맞게 연기를 잘하던 차재현이, 유독 도유진하고<br>과거를 사과하는 씬을 맞출 때만 목소리가 미세하게<br>떨리는 것 같다.<br><br>차재현은 왜 그랬을까?",
        img1:"assets/q6_1.png", img2:"assets/q6_2.png",
        choices:[
            {text:"동성이어도 얼굴 천재 앞에서는 별 수 없이 넋이 나가는 거지 뭐", score:5},
            {text:"차재현이 저런 애가 아닌데,\n둘이 뭔가 있는 거 아니야?", score:10},
            {text:"차재현 요즘 게임에 미쳐 있다더니,\n정신 못 차리나 봐", score:0}
        ]
    },
    {
        q:"연극제 대기실에서 도유진이 그윽한 표정으로<br>차재현의 손목을 잡고 있는 묘한 사진이<br>학교 익명 게시판에 올라왔다!<br><br>범인은 도대체 왜 이런 짓을 했을까?",
        img1:"assets/q7_1.png", img2:"assets/q7_2.png",
        choices:[
            {text:"도유진이랑 차재현이 잘 지내는 꼴을 보기가 싫어서", score:5},
            {text:"이은성이 도유진이 자기 좋아하는 줄 착각해서,\n상처받으라고 일부러 올렸나?", score:10},
            {text:"사진 자체가 너무 특종인데 이걸 안 올릴 수가 없잖아?", score:0}
        ]
    },
    {
        q:"익명 게시판 폭로 이후,<br>반 대표 빌런 남학생이 도유진을 향해 선 넘는 조롱을 쏟아낸다.<br>그때, 소심하던 이은성이 일어나 빌런의 머리에<br>우유를 냅다 부어버렸다?<br><br>은성이의 미친 용기는 어디서 나온 걸까?",
        img1:"assets/q8_1.png", img2:"assets/q8_2.png",
        choices:[
            {text:"둘이 비밀 연애 중인데 남친 건드려서 빡친 거겠지", score:5},
            {text:"소심한 성격을 이겨낼 만큼 이은성이 도유진을 짝사랑하고 있다는 거지", score:10},
            {text:"이은성, 그렇게 안 봤는데 원래 한 성격하는 사이다 인간이었던 거야?", score:0}
        ]
    },
    {
        q:"평소 꾸미는 데 관심 없던 이은성이 리본 핀을 하고 왔다.<br>도유진이 다가가 이은성에게 속삭인다.<br>'내가 보내준 그림이랑 똑같네?'<br>이은성의 얼굴이 터질 듯 붉어졌다.<br><br>이건 또 무슨 시그널일까?",
        img1:"assets/q9_1.png", img2:"assets/q9_2.png",
        choices:[
            {text:"와, 우유 사건 이후로 도유진이 플러팅하는 것 같은데?", score:5},
            {text:"어? 저 리본 핀 요즘 유행해?\n윤해수도 있던데, 나도 하나 살까?", score:0},
            {text:"'내가 보내준 그림?'\n둘이 수상해 보이더니 비밀 얘기 하나 봐!", score:10},
        ]
    },
    {
        q:"갑자기 폭우가 쏟아지는 하굣길.<br>도유진은 우산이 없는 이은성에게<br>자기 우산을 쥐여주고 빗속을 뛰어간다.<br>그리고 도착한 곳은...<br>저 멀리 서 있던 차재현의 우산 속!<br><br>이게 도대체 무슨 상황이지?",
        img1:"assets/q10_1.png", img2:"assets/q10_2.png",
        choices:[
            {text:"비오는데 우산 없는 여자애를 그냥 내버려두면 남자가 아니지!", score:0},
            {text:"이은성에게 우산 줘서 호감도 올리고 빗속을 달리면서 남성미도 어필하고.\n완벽한 큰 그림이잖아?", score:5},
            {text:"이은성도 이은성이지만\n진짜 목적지는 차재현의 우산 속이었던 거 아니야?", score:10},
        ]
    }
];
