...
const questions = [
    {
        ...
        choices:[
            ...
            {text:"당연히 송현고 여신 윤해수일 듯. 딱 봐도 남주 여주 같잖아! 둘이 곧 사귀겠네", score:5},
            {text:"잠깐, 시선의 방향이 미묘한데? 설마 대본 연습 중인 연극부장 차재현을 보고 있는 거 아냐?", score:10},
        ]
    },
    {
        q:"연극부장 차재현은 워낙 인싸라 남녀 가리지 않고 어깨동무를 척척 걸치는데, 유독 전학생 도유진이 다가올 때만 귀까지 빨개져서 뒷걸음질을 친다. 이 텐션, 대체 뭘까?",
        img1:"assets/q2_1.png", img2:"assets/q2_2.png",
        choices:[
            {text:"어제 둘이 싸웠나 보다. 아니면 유진이한테서 땀 냄새 나서 피하는 건가?", score:0},
    ...
    },
    {
        ...
        choices:[
            ...
            {text:"둘이 접점이 하나도 없는데. 약점이라도 잡혔나?", score:10},
            {text:"맨 뒷자리 구석 완전 명당이잖아, 엎드려 자도 쌤한테 절대 안 걸리는 자리!", score:0}
        ]
    },
    {
        q:"이은성과 화장실도 같이 가던 껌딱지 오수아. 최근 이은성이 조별 과제로 남학생들과 친해지자,왠지 오수아의 태도가 차가워졌다. 오수아의 속마음은 뭘까?",
        img1:"assets/q4_1.png", img2:"assets/q4_2.png",
        choices:[
            {text:"이은성이 친구가 많아지니까 자기는 버림받을까 봐 두렵고 질투나는 거 아냐?", score:10},
            {text:"저 남학생 중에 오수아가 좋아하는 애가 있나 봐", score:5},
            {text:"조별 과제를 남자애들이 다 해줬다던데, 그래서 괜히 심통 났나봐", score:0}
        ]
    },
    {
        q:"이은성이 유독 우울해 보이던 날 아침, 책상 위에 이은성이 좋아하는 딸기바 아이스크림이 놓여 있다. 그걸 본 이은성이 굳어 버리자, 오수아는 애써 시선을 피하며 엎드리고 도유진은 그 광경을 가만히 지켜보고 있다. 저 아이스크림은 누가, 왜 둔 걸까?",
    ...
    {
        q:"연극부 대본 리딩 시간. 평소 능글맞게 연기를 잘하던 차재현이, 유독 도유진하고 과거를 사과하는 씬을 맞출 때만 목소리가 미세하게 떨리는 것 같다. 차재현은 왜 그랬을까?",
        ...
        choices:[
            ...
            {text:"차재현 요즘 게임에 미쳐 있다더니, 정신 못 차리나 봐", score:0}
        ]
    },
    {
        q:"연극제 대기실에서 도유진이 그윽한 표정으로 차재현의 손목을 잡고 있는 묘한 사진이 학교 익명 게시판에 올라왔다! 범인은 도대체 왜 이런 짓을 했을까?",
        img1:"assets/q7_1.png", img2:"assets/q7_2.png",
        choices:[
            {text:"도유진이랑 차재현이 잘 지내는 꼴을 보기가 싫어서, score:5},
            {text:"이은성이 도유진이 자기 좋아하는 줄 착각해서, 상처받으라고 일부러 올렸나?", score:10},
    ...
    },
    {
        ...
        choices:[
            ...
            {text:"어? 저 리본 핀 요즘 유행해? 윤해수도 있던데, 나도 하나 살까?", score:0},
            {text:"'내가 보내준 그림?' 둘이 수상해 보이더니 비밀 얘기 하나 봐!", score:10},
        ]
    },
    {
        q:"갑자기 폭우가 쏟아지는 하굣길. 도유진은 우산이 없는 이은성에게 자기 우산을 쥐여주고 빗속을 뛰어간다. 그리고 도착한 곳은... 저 멀리 서 있던 차재현의 우산 속! 이게 도대체 무슨 상황이지?",
        img1:"assets/q10_1.png", img2:"assets/q10_2.png",
        choices:[
            {text:"비오는데 우산 없는 여자애를 그냥 내버려두면 남자가 아니지!", score:0},
            {text:"이은성에게 우산 줘서 호감도 올리고 빗속을 달리면서 남성미도 어필하고. 완벽한 큰 그림이잖아?", score:5},
            {text:"이은성도 이은성이지만 진짜 목적지는 차재현의 우산 속이었던 거 아니야?", score:10},
        ]
    }
];
