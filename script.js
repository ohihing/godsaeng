...
const questions = [
    {
        q:"나른한 문학 시간,\n얼굴 천재 전학생 유진이가 자꾸 우리 분단 쪽을 빤히 쳐다본다.\n그 시선의 끝엔 학교 여신 '윤해수', 연극부장 '차재현',\n그리고 조용한 '이은성'이 있다.\n\n당신의 촉이 발동하는 방향은?",
    ...
    {
        q:"연극부장 차재현은 워낙 인싸라\n남녀 가리지 않고 어깨동무를 척척 걸치는데,\n유독 전학생 도유진이 다가올 때만 귀까지 빨개져서\n뒷걸음질을 친다.\n\n이 텐션, 대체 뭘까?",
    ...
    {
        q:"제비뽑기로 자리를 바꾸는 날.\n가장 먼저 번호를 뽑은 전학생 도유진이 향한 곳은,\n밝은 분위기의 친구들이 모인 명당이나 여신 윤해수의\n옆자리가 아니었다.\n도유진이 고른 자리는 굳이 교실 맨 구석, 조용한 이은성의\n바로 뒷자리?\n\n대체 왜 저길 고른 걸까?",
    ...
    {
        q:"이은성과 화장실도 같이 가던 껌딱지 오수아.\n최근 이은성이 조별 과제로 남학생들과 친해지자,\n왠지 오수아의 태도가 차가워졌다.\n\n오수아의 속마음은 뭘까?",
    ...
    {
        q:"이은성이 유독 우울해 보이던 날 아침,\n책상 위에 이은성이 좋아하는 딸기바 아이스크림이 놓여 있다.\n그걸 본 이은성이 굳어 버리자, 오수아는 애써 시선을 피하며 엎드리고\n도유진은 그 광경을 가만히 지켜보고 있다.\n\n저 아이스크림은 누가, 왜 둔 걸까?",
    ...
    {
        q:"연극부 대본 리딩 시간.\n평소 능글맞게 연기를 잘하던 차재현이, 유독 도유진하고\n과거를 사과하는 씬을 맞출 때만 목소리가 미세하게\n떨리는 것 같다.\n\n차재현은 왜 그랬을까?",
    ...
    {
        q:"연극제 대기실에서 도유진이 그윽한 표정으로\n차재현의 손목을 잡고 있는 묘한 사진이\n학교 익명 게시판에 올라왔다!\n\n범인은 도대체 왜 이런 짓을 했을까?",
    ...
    {
        q:"익명 게시판 폭로 이후,\n반 대표 빌런 남학생이 도유진을 향해 선 넘는 조롱을 쏟아낸다.\n그때, 소심하던 이은성이 일어나 빌런의 머리에\n우유를 냅다 부어버렸다?\n\n은성이의 미친 용기는 어디서 나온 걸까?",
    ...
    {
        q:"평소 꾸미는 데 관심 없던 이은성이 리본 핀을 하고 왔다.\n도유진이 다가가 이은성에게 속삭인다.\n'내가 보내준 그림이랑 똑같네?'\n이은성의 얼굴이 터질 듯 붉어졌다.\n\n이건 또 무슨 시그널일까?",
